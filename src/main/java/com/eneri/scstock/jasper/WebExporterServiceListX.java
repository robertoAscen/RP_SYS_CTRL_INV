 ...
 * @author RAscencio
 */
public class WebExporterServiceListX implements Serializable
{
  ...
  public static void exportToPdfAndShowOnBrowser(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, ON_BROWSER, TYPE_PDF, 
      fileName, new JRPdfExporter(), request, response);
  }
  ...
  public static void exportToPdfAndShowSaveFile(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, SAVE_IN_FILE, 
      TYPE_PDF, fileName, new JRPdfExporter(), request, response);
  }
  ...
  public static void exportToCsvAndShowOnBrowser(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, ON_BROWSER, TYPE_CSV, 
      fileName, new JRCsvExporter(), request, response);
  }
  ...
  {
    generateReport(filePath, parametersReport, lData, SAVE_IN_FILE, 
      TYPE_CSV, fileName, new JRCsvExporter(), request, response);
  }
  ...
  public static void exportToXlsAndShowOnBrowser(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, ON_BROWSER, TYPE_XLS, 
      fileName, new JRXlsExporter(), request, response);
  }
  ...
  {
    generateReport(filePath, parametersReport, lData, SAVE_IN_FILE, 
      TYPE_XLS, fileName, new JRXlsExporter(), request, response);
  }
  ...
  public static void exportToDocAndShowOnBrowser(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, ON_BROWSER, TYPE_DOC, 
      fileName, new JRRtfExporter(), request, response);
  }
  ...
  {
    generateReport(filePath, parametersReport, lData, SAVE_IN_FILE, 
      TYPE_DOC, fileName, new JRRtfExporter(), request, response);
  }
  ...
  public static void exportToXmlAndShowOnBrowser(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, ON_BROWSER, TYPE_XML, 
      fileName, new JRXmlExporter(), request, response);
  }
  ...
  {
    generateReport(filePath, parametersReport, lData, SAVE_IN_FILE, 
      TYPE_XML, fileName, new JRXmlExporter(), request, response);
  }
  ...
  public static void exportToHtmlAndShowOnBrowser(String filePath, Map parametersReport, List lData, String fileName, HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    generateReport(filePath, parametersReport, lData, ON_BROWSER, 
      TYPE_HTML, fileName, new JRHtmlExporter(), request, response);
  }
  ...
  {
    JasperPrint printer = 
      JasperFillManager.fillReport(WebExporterServiceList.class
      .getResourceAsStream(filePath), parametersReport, 
      new JRBeanCollectionDataSource(lData));
    ...
    if ((exporter instanceof JRHtmlExporter))
    {
      request.getSession().setAttribute(
        "net.sf.jasperreports.j2ee.jasper_print", printer);
