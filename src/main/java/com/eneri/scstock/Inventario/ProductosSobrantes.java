 ...
 * @author RAscencio
 */
public class ProductosSobrantes extends JDialog
{
    
  private JTabbedPane tabbedPane;
  public static DefaultTableModel modelo = new DefaultTableModel(null, new String[] { "C�d. del producto", "Descripci�n", "U.M.", "Stock act.", "Sobra", "Costo", "Sub-Total" })
  {
  ...
  public static void main(String[] args)
  {
    EventQueue.invokeLater(new Runnable()
    {
      public void run()
      {
        try
        {
          ProductosSobrantes dialog = new ProductosSobrantes();
  ...
  public ProductosSobrantes()
  {
    setTitle("Productos sobrantes");
    setResizable(false);
    ...
    this.btnConsultar.addActionListener(new ActionListener()
    {
      ...
      {
        ProductosSobrantes.this.CargarProductosSobrantes();
      }
    });
    ...
    JLabel lblProductosFaltantes = new JLabel("Productos sobrantes");
  ...
  public void CargarProductosSobrantes()
  {
    lista = new ArrayList();
    lista = DaoInventarios.ConsultarProductosSobrantes();
